...
my_api_key = "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"  # 在这里输入你的 API 密钥
...
if __name__ == "__main__":
    ...
    # if not running in Docker
        ...
        # 可自定义端口 demo.queue(concurrency_count=CONCURRENT_COUNT).launch(server_name="0.0.0.0", server_port=7860,
        # auth=("在这里填写用户名", "在这里填写密码")) # 可设置用户名与密码 demo.queue(concurrency_count=CONCURRENT_COUNT).launch(auth=(
        # "在这里填写用户名", "在这里填写密码")) # 适合Nginx反向代理
